...
vaccination][wapost_facebook_vaccine]. Similarly, one of the designers of the
game *Ultima Online* [reported][ultima_online_players], "…we asked players what
...
The first rule in [% x meetings %] was to agree on what the
...
[Captain Awkward][captain_awkward] has useful advice for discussions like these,
and [Charles' Rules of Argument][charles_rules] are very useful online.
